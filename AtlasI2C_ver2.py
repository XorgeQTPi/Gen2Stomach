...
class AtlasI2C:
    ...
    def write(self, cmd):
        ...
        cmd += "\00"
        cmd = cmd.encode() # convert to binary
    ...
    def read(self, num_of_bytes=31):
        ...
        if response[0] == 1:             # if the response isn't an error
            ...
            return (True,''.join(char_list).rstrip('\x00'))     # convert the char list to a string and returns it
        else:
            return (False,str(response[0]).rstrip('\x00'))
